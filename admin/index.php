...
if ($filter !== 'all') {
    $wishes = array_values(array_filter($wishes, fn($w) => $w['status'] === $filter));
}
...
<head>
    ...
    <style>
        ...
        .wish-item { background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; padding: 1rem; }
        .wish-item.pending { border-left: 3px solid #ffd166; }
        .wish-item.approved { border-left: 3px solid #06d6a0; }
        .wish-item.rejected { border-left: 3px solid #ef476f; opacity: 0.6; }
        ...
        .btn-approve { background: #06d6a0; color: #1a0f2e; }
        .btn-reject { background: #ef476f; color: #fff; }
        ...
        .badge-pending { background: rgba(255,209,102,0.2); color: #ffd166; }
        .badge-approved { background: rgba(6,214,160,0.2); color: #06d6a0; }
        .badge-rejected { background: rgba(239,71,111,0.2); color: #ef476f; }
            ...
            <?php foreach ($wishes as $wish): ?>
                ...
                <div class="wish-item <?= implode(' ', $classes) ?>">
                    ...
                    <div class="wish-meta">
                        ...
                        &nbsp;·&nbsp;
                        <span class="badge badge-<?= $wish['status'] ?>"><?= $wish['status'] ?></span>
                    ...
                    <div class="wish-actions">
                        ...
                        <?php endif; ?>
                        <?php if ($wish['status'] === 'approved' && $wish['winner'] !== '1'): ?>
                            <form method="POST" style="display:inline">
                                <input type="hidden" name="id" value="<?= htmlspecialchars($wish['id']) ?>">
